...
namespace SPH
{
	...
	*/
	...
	protected:
		...
		void pressureSolveIterationMLS(const unsigned int fluidModelIndex, Real &avg_density_err);
		void divergenceSolve();
		void divergenceSolveIteration(const unsigned int fluidModelIndex, Real &avg_density_err);
		void divergenceSolveIterationMLS(const unsigned int fluidModelIndex, Real &avg_density_err);
