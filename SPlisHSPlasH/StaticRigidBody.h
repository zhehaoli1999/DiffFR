...
{	
	...
	*/
	...
	public:
		...
		virtual Matrix3r const getInertiaTensorInverseWorld() const { return Matrix3r::Zero(); }
		virtual Matrix3r const getInertiaTensorWorld() const { return Matrix3r::Zero(); }
		...
		virtual Quaternionr const& getLastRotation() const { return m_q; }
