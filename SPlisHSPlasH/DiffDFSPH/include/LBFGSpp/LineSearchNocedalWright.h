...
public:
                           ...
                           Scalar& step, Scalar& fx, Vector& grad, Scalar& dg, Vector& x)
    {
        ...
        for (;;)
        {
            ...
            std::cout << "   step = " << step << ", step_hi = " << step_hi << ", step_low = " << step_lo << '\n';

            x.noalias() = xp + step * drt;
            fx = f(x, grad);

            std::cout << "   x = " << x.transpose() << std::endl;
            std::cout << "   f(x) = " << fx << ", grad = " << grad.transpose() << std::endl << std::endl;
            ...
            {
                std::cout << "  choose step_hi = step " << std::endl;
                if (step == step_hi)
            ...
            else
            {
                ...
                std::cout << "  choose step_lo = step " << std::endl;
