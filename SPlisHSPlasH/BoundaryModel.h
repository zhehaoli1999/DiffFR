	...
	*/
	class BoundaryModel 
	{
		...
		protected:
			...
			std::vector<Vector3r> m_forcePerThread_backup;
			std::vector<Vector3r> m_torquePerThread_backup;

//#ifdef BACKWARD 
      //Matrix3r m_grad_a_to_x; 
      //Matrix3r m_grad_a_to_v; 
//#endif 
       ...
       //TODO: differentiate this addForce  
