...
void BoundaryModelModule(py::module m_sub){
    ...
    py::class_<SPH::BoundaryModel>(m_sub, "BoundaryModel")
            ...
            .def("getForce", &SPH::BoundaryModel::getForce) 
            .def("getTorque", &SPH::BoundaryModel::getTorque) 
    ...
    py::class_<SPH::BoundaryModel_Akinci2012, SPH::BoundaryModel>(m_sub, "BoundaryModelAkinci2012")
            ...
            .def("get_position_rb", &SPH::BoundaryModel_Akinci2012::get_position_rb)
            .def("get_quaternion_rb_vec4", &SPH::BoundaryModel_Akinci2012::get_quaternion_rb_vec4)
            .def("get_velocity_rb", &SPH::BoundaryModel_Akinci2012::get_velocity_rb)
            .def("get_angular_velocity_rb", &SPH::BoundaryModel_Akinci2012::get_angular_velocity_rb)
            .def("set_velocity_rb", &SPH::BoundaryModel_Akinci2012::set_velocity_rb)
            .def("set_angular_velocity_rb", &SPH::BoundaryModel_Akinci2012::set_angular_velocity_rb)
            .def("set_angular_velocity_rb_to_joint", &SPH::BoundaryModel_Akinci2012::set_angular_velocity_rb_to_joint)
            .def("add_angular_velocity_rb_to_joint", &SPH::BoundaryModel_Akinci2012::add_angular_velocity_rb_to_joint)

            .def("get_grad_x_to_v0", &SPH::BoundaryModel_Akinci2012::get_grad_x_to_v0)
            .def("get_grad_x_to_omega0", &SPH::BoundaryModel_Akinci2012::get_grad_x_to_omega0)
            .def("get_grad_quaternion_to_omega0", &SPH::BoundaryModel_Akinci2012::get_grad_quaternion_to_omega0)
            .def("get_grad_quaternion_to_v0", &SPH::BoundaryModel_Akinci2012::get_grad_quaternion_to_v0)
            .def("get_grad_v_to_v0", &SPH::BoundaryModel_Akinci2012::get_grad_v_to_v0)
            .def("get_grad_v_to_omega0", &SPH::BoundaryModel_Akinci2012::get_grad_v_to_omega0)
            .def("get_grad_omega_to_omega0", &SPH::BoundaryModel_Akinci2012::get_grad_omega_to_omega0)
            .def("get_grad_omega_to_v0", &SPH::BoundaryModel_Akinci2012::get_grad_omega_to_v0)

            //.def("get_grad_rootRB_xn_to_actuator_omega0", &SPH::BoundaryModel_Akinci2012::get_grad_rootRB_xn_to_actuator_omega0)

            //.def("get_grad_x_to_v0_another_bm", &SPH::BoundaryModel_Akinci2012::get_grad_x_to_v0_another_bm)
            .def("get_grad_x_to_omega0_another_bm", &SPH::BoundaryModel_Akinci2012::get_grad_x_to_omega0_another_bm)
            .def("get_grad_x_to_v0_another_bm", &SPH::BoundaryModel_Akinci2012::get_grad_x_to_v0_another_bm)
            //.def("get_grad_quaternion_to_omega0_another_bm", &SPH::BoundaryModel_Akinci2012::get_grad_quaternion_to_omega0_another_bm)
            .def("get_grad_quaternion_to_v0_another_bm", &SPH::BoundaryModel_Akinci2012::get_grad_quaternion_to_v0_another_bm);
            //.def("get_grad_v_to_v0_another_bm", &SPH::BoundaryModel_Akinci2012::get_grad_v_to_v0_another_bm)
            //.def("get_grad_v_to_omega0_another_bm", &SPH::BoundaryModel_Akinci2012::get_grad_v_to_omega0_another_bm)
            //.def("get_grad_omega_to_omega0_another_bm", &SPH::BoundaryModel_Akinci2012::get_grad_omega_to_omega0_another_bm)
            //.def("get_grad_omega_to_v0_another_bm", &SPH::BoundaryModel_Akinci2012::get_grad_omega_to_v0_another_bm)
            
            //.def("get_grad_x_to_omega0_fixed_joint", &SPH::BoundaryModel_Akinci2012::get_grad_x_to_omega0_fixed_joint)
            //.def("get_grad_quaternion_to_omega0_fixed_joint", &SPH::BoundaryModel_Akinci2012::get_grad_quaternion_to_omega0_fixed_joint)
            //.def("get_grad_v_to_omega0_fixed_joint", &SPH::BoundaryModel_Akinci2012::get_grad_v_to_omega0_fixed_joint)
            //.def("get_grad_omega_to_omega0_fixed_joint", &SPH::BoundaryModel_Akinci2012::get_grad_omega_to_omega0_fixed_joint);
