...
void py_init_simulator(SPH::SimulatorBase& obj,
                       ...
                       bool loadFluidPos = false, 
                       bool loadFluidPosAndVel = false, 
					   ...
					   std::string param="")
                       {
                           ...
                           if(loadFluidPos) argv.push_back("--load-fluid-pos");
                           if(loadFluidPosAndVel) argv.push_back("--load-fluid-pos-and-vel");
...
void SimulationModule(py::module m_sub){
    ...
    py::class_<SPH::Simulation, GenParam::ParameterObject>(m_sub, "Simulation")
            ...
            .def("setGradientMode", &SPH::Simulation::setGradientMode)
            .def("getGradientMode", &SPH::Simulation::getGradientMode)
            .def("useRigidGradientManager", &SPH::Simulation::useRigidGradientManager)
            ;
    ...
    py::class_<SPH::SimulatorBase, GenParam::ParameterObject>(m_sub, "SimulatorBase")
            ...
            .def("init", &py_init_simulator, 
                            ...
                            "useCache"_a = true,
                            "stateFile"_a = "",
                            "loadFluidPos"_a = false,
                            "loadFluidPosAndVel"_a = false,
                            "outputDir"_a = "",
            ...
            .def("initSimulationWithDeferredInit", &SPH::SimulatorBase::initSimulationWithDeferredInit)
      			.def("runSimulation", &SPH::SimulatorBase::runSimulation)
      			.def("runNewTrajectory", &SPH::SimulatorBase::runNewTrajectory)
      			.def("forwardFixedSteps", &SPH::SimulatorBase::forwardFixedSteps)
            .def("cleanup", &SPH::SimulatorBase::cleanup)

            .def("reset", &SPH::SimulatorBase::reset)
            .def("timeStep", &SPH::SimulatorBase::timeStep)
            .def("singleTimeStep", &SPH::SimulatorBase::singleTimeStep)
            .def("runFixedTimeSteps", &SPH::SimulatorBase::runFixedTimeSteps)
            ...
            .def("setStateExportPath", &SPH::SimulatorBase::setStateExportPath)
            .def("loadStateWithRigidExisted", &SPH::SimulatorBase::loadStateWithRigidExisted)
            ...
            .def("getRigidBodyGradientManager", &SPH::SimulatorBase::getRigidBodyGradientManager, py::return_value_policy::reference_internal)
            ...
            .def("setTimeStepCallBefore", &SPH::SimulatorBase::setTimeStepCallBefore)
    ...
    py::class_<SPH::BoundarySimulator>(m_sub, "BoundarySimulator")
            ...
            .def("getRigidContactSolver", &SPH::BoundarySimulator::getRigidContactSolver, py::return_value_policy::reference)
    ...
    // RigidContactSolver
    // ---------------------------------------
    py::class_<SPH::RigidContactSolver>(m_sub, "RigidContactSolver")
        .def(py::init<>())
       .def("reset", &SPH::RigidContactSolver::reset);
       //.def("get_grad_x_to_v0", &SPH::RigidContactSolver::get_grad_x_to_v0) 
       //.def("get_grad_x_to_omega0", &SPH::RigidContactSolver::get_grad_x_to_omega0)
       //.def("get_grad_q_to_v0", &SPH::RigidContactSolver::get_grad_q_to_v0) 
       //.def("get_grad_q_to_omega0", &SPH::RigidContactSolver::get_grad_q_to_omega0);

    // ---------------------------------------
    // RigidBodyGradientManager
    // ---------------------------------------
    py::class_<SPH::RigidBodyGradientManager>(m_sub, "RigidBodyGradientManager")
        .def(py::init<>())
       .def("reset", &SPH::RigidBodyGradientManager::reset)
       .def("get_grad_net_force_to_vn", &SPH::RigidBodyGradientManager::get_grad_net_force_to_vn) 
       .def("get_grad_net_torque_to_omega_n", &SPH::RigidBodyGradientManager::get_grad_net_torque_to_omega_n) 
       .def("get_grad_x_to_omega0", &SPH::RigidBodyGradientManager::get_grad_xn_to_omega0)
       .def("get_grad_x_to_v0", &SPH::RigidBodyGradientManager::get_grad_xn_to_v0) 
       .def("get_grad_q_to_v0", &SPH::RigidBodyGradientManager::get_grad_qn_to_v0) 
       .def("get_grad_q_to_omega0", &SPH::RigidBodyGradientManager::get_grad_qn_to_omega0);
}
